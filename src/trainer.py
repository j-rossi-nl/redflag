"""
LITTERAL COPY OF transformers/trainer.py
Had to customize it for usage (avoid the SUmmaryWriter does not have attribute add_hparams
Without upgrading Pytorch
See https://github.com/huggingface/transformers/issues/4511
In the end, Tensorboard is completly deactivated.
...
# SummaryWriter from tensorboardX has the attribute add_hparams
from tensorboardX import SummaryWriter

# In fact we don't need Tensorboard
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    if self.is_local_master():
                        if (self.args.logging_steps > 0 and global_step % self.args.logging_steps == 0) or (
                            ...
                            learning_rate_scalar = scheduler.get_lr()[0]   # was: get_last_lr() / Not in 1.1.0
